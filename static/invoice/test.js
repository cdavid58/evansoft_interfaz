...
$(document).ready(function() {
	            ...
	            $.ajax({
	                ...
	                success: function(e) {
	                    ...
	                    if (e.result) {
	                        ...
	                        if(type_price == 1 || type_price == 4) _type_price = 1;
	                        if(type_price == 2 || type_price == 5) _type_price = 2;
	                        if(type_price == 3 || type_price == 6) _type_price = 3;
    ...
    // let socket = new WebSocket(url_websocket);
	...
	// // Al cargar la página, si hay internet arranca
